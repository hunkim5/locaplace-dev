...
public class ReservationDto {
	...
	@Schema(description="환불은행명")
	private String bankName;
	@Schema(description="환불계좌번호")
	private String accountNo;
	@Schema(description="환불계좌소유자명")
	private String accountOwner;
	@Schema(description="환불계좌인증여부")
	private String paybackAccountCertifyYn;
